    ...
    return (
        ...
        <p>{formerror}</p>
                ...
                <div>
                    ...
                    <input required type={"password"} name="password" onChange={e => setRegisterPassword(e.target.value)}></input>
                </div>
                <div>
                    <label>Confirmation de mot de passe</label>
                    <input required  type={"password"} name="password" onChange={e => setregisterPasswordConfirm(e.target.value)}></input>
                </div>
